...
const documents: Document[] = [
  { id: "doc-1", title: "Getting Started", content: "To install, run bun install agent-testing-library.", source: "docs", score: 0.92 },
...
function baseMocks(overrides: Record<string, ReturnType<typeof mock.fn>> = {}) {
  return {
    ...
    generate: mock.fn({ text: "To install, run bun install agent-testing-library.", tokensUsed: 80 }),
    ...overrides,
  };
}
